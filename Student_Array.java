...
public class Student_Array {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			case 3:
				...
				index = sc.nextInt();
				studs = deleteStudents(index,studs);
				printList(studs);
				break;
		   case 4:
	...
	private static void addStudents(Student[] studs) {
	...
	private static void printList(Student[] studs) {
	...
	private static Student[] deleteStudents(int index, Student[] studs) {
